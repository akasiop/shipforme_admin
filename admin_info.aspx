<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_info.aspx.cs" Inherits="admin_index_admin_info" %>
		    ...
		    <div class="layui-tab-item">
		    	<form class="layui-form" v style="width: 90%;padding-top: 20px;">
				  <div class="layui-form-item">
				    <label class="layui-form-label">用户名：</label>
				    <div class="layui-input-block">
				      <input type="text" name="username" disabled autocomplete="off" class="layui-input layui-disabled" value="2001">
				    </div>
				  </div>
				  <div class="layui-form-item">
				    <label class="layui-form-label">旧密码：</label>
				    <div class="layui-input-block">
                        <asp:TextBox ID="old_Pass" runat="server" placeholder="请输入密码" class="layui-input"></asp:TextBox>
				  ...
				  <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <asp:TextBox ID="new_Pass" runat="server" placeholder="请输入密码" class="layui-input"></asp:TextBox>
				    </div>
				  </div>
				  <div class="layui-form-item">
				    <label class="layui-form-label">重复密码：</label>
				    <div class="layui-input-block">
				      <asp:TextBox ID="new_Pass2" runat="server" placeholder="请输入密码" class="layui-input"></asp:TextBox>
				    </div>
				  </div>
				  <div class="layui-form-item">
				    <div class="layui-input-block">
